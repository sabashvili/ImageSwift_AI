...
function PricingPage() {
  const basicPlan: any = {
    plan: "basic plan",
    price: "12",
    listOfConditions: ["15h Fast generations", "Access to member gallery", "General commercial terms"],
  };
  ...
  const proPlan: any = {
    plan: "pro plan",
    price: "60",
    listOfConditions: ["15h Fast generations", "Access to member gallery", "3 concurrent fast jobs"],
  };
