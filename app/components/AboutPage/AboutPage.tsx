  ...
  return (
    <section id="about">
      ...
      <div className="sectionContainer">
        ...
        <h2 className="secondary-header-section">fresh story for every channel</h2>
          ...
          {socialNetworks.map((networks, index) => {
            return (
              <li key={index} className={classes["social-icon-flex-container"]}>
                <a className={classes["social-icon-container"]} href={`${networks.href}`} target="_blank">
                  <Image className={classes["social-icon"]} src={networks.logo} alt="profile picture" />
                </a>
              </li>
            );
          })}
